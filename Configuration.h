...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 265 // mm

  // height from z=0 to home position
  #define DELTA_HEIGHT 292 // get this value from auto calibrate
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -20.5  // Z offset: -below +above  [the nozzle]
